...
bool spass_line_process (struct ast lt, s_table *table, line_info line) {
    ...
    if (lt.ast_union_option == ast_union_asm_inst) {
        if (lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_add ||
            ...
            || lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_mov) {
            if (lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oat[0] == ast_op_addr_type_label) {
                if (get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[0].label) ==
                    NULL) {
                    print_error_msg(&line, "The label %s is used but not defined",
                                    lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[0].label);
                    return FALSE;
                }
            } else if (lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oat[1] == ast_op_addr_type_label) {
                if (get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[1].label) ==
                    NULL) {
                    print_error_msg(&line, "The label %s is used but not defined",
                                    lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[1].label);
                    return FALSE;
                }
            }
        } else if (lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_inc ||
                   lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_dec ||
                   lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_not ||
            ...
            if (lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.oat == ast_op_addr_type_label) {
                if (get_from_s_table(table,
                                     lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.oatu.label) ==
                    NULL) {
                    print_error_msg(&line, "The label %s is used but not defined",
                                    lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.oatu.label);
                    return FALSE;
        ...
        else if (lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_jsr || lt.asm_inst_asm_dir.asm_inst.inst_name == ast_inst_bne ||
            ...
            if (lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.oat == ast_op_addr_type_label) {
                ...
                if (get_from_s_table(table,
                    ...
                    if (get_from_s_table(table,
                                         lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[0].label) ==
                        NULL) {
                        print_error_msg(&line, "The label %s is used but not defined",
                                        lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[0].label);
                        return FALSE;
                        ...
                        ast_op_addr_type_label) {
                    if (get_from_s_table(table,
                                         lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[1].label) ==
                        NULL) {
                        print_error_msg(&line, "The label %s is used but not defined",
                                        lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[1].label);
                        return FALSE;
    ...
    if (lt.asm_inst_asm_dir.asm_dir.ast_union_asm_dir_option == ast_union_asm_dir_entry) {
