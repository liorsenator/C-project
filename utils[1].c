...
void print_error_msg (line_info *line, const char *format, ...) { /*Check this whole function - seems not relavent to our project
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
    va_list  args;
...
void print_dw (data_word word) { /*Not sure if relavant !!!!!!!!!!!!!!!!!!!!!!!!!!!*/
    int i;
    for (i=11; i>=0; i--) {
        putchar((word.data >> 1) & 1? '1' : '0');
    }
    putchar('\n');
}
...
bool is_valid_label (char *word) {
    ...
    if (word[strlen(word) - 1] == ':') {
        ...
        label[i] = '\0';
    } else { /* Label comes from analyzing operands */
